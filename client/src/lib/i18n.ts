  ...
  en: {
    translation: {
      ...
      shipping: {
        ...
        packagingInstructionsAr: "Packaging Instructions (Arabic)",
        packagingInstructionsPlaceholder: "Enter packaging instructions",
        packagingInstructionsArPlaceholder: "Enter packaging instructions in Arabic",
      ...
      invoice: {
        ...
        pdfDownloadErrorDesc: "There was an error generating the invoice PDF",
        zatcaSubmitSuccess: "ZATCA Submission Successful",
        zatcaSubmitSuccessDesc: "Invoice has been submitted to ZATCA portal",
        zatcaSubmitError: "ZATCA Submission Failed",
        zatcaSubmitErrorDesc: "Failed to submit invoice to ZATCA portal",
  ...
  ar: {
    translation: {
      ...
      shipping: {
        ...
        deliverySuccessRate: "معدل نجاح التسليم",
        ordersInTransit: "الطلبات في الطريق",
        ...
        shipped: "تم الشحن",
        cancelled: "ملغي",
        filterByCarrier: "تصفية حسب شركة الشحن",
        ...
        adjust: "تعديل",
        criteria: "المعايير",
        contactEmailPlaceholder: "أدخل البريد الإلكتروني للتواصل",
        packagingInstructions: "تعليمات التغليف",
        packagingInstructionsAr: "تعليمات التغليف (بالعربية)",
        packagingInstructionsPlaceholder: "أدخل تعليمات التغليف",
        packagingInstructionsArPlaceholder: "أدخل تعليمات التغليف بالعربية",
      ...
      invoice: {
        ...
        noDraftInvoices: "لا توجد فواتير مسودة",
        noSentInvoices: "لا توجد فواتير مرسلة",
        ...
        shippingAmount: "الشحن (ر.س)",
        referenceNumber: "الرقم المرجعي",
        supplyDate: "تاريخ التوريد",
        notes: "ملاحظات (بالإنجليزية)",
        ...
        updateStatus: "تحديث الحالة",
        buyer: "المشتري",
        downloadingPdf: "جاري تحميل PDF...",
        pdfDownloadError: "فشل تحميل PDF",
        pdfDownloadErrorDesc: "حدث خطأ في إنشاء ملف PDF للفاتورة",
        zatcaSubmitSuccess: "تم الإرسال إلى ZATCA بنجاح",
        zatcaSubmitSuccessDesc: "تم إرسال الفاتورة إلى بوابة ZATCA",
        zatcaSubmitError: "فشل الإرسال إلى ZATCA",
        zatcaSubmitErrorDesc: "فشل إرسال الفاتورة إلى بوابة ZATCA",
...
noComments: "لا توجد تعليقات بعد",
      ...
      workshops: {
        ...
        materialsAr: "المواد بالعربية",
        materialPlaceholderAr: "أدخل المادة بالعربية",
        ...
        cancelled: "ملغي",
        completed: "مكتمل",
        isOnline: "فعالية عبر الإنترنت",
        meetingLink: "رابط الاجتماع",
        images: "الصور",
        participants: "المشاركون",
        deleteConfirm: "هل أنت متأكد من حذف هذه الورشة؟",
        noWorkshops: "لا توجد ورش عمل",
        createFirst: "أنشئ ورشة العمل الأولى",
        createSuccess: "تم إنشاء ورشة العمل",
        createSuccessDesc: "تم إنشاء ورشة العمل بنجاح",
        createError: "خطأ في الإنشاء",
        updateSuccess: "تم تحديث ورشة العمل",
        updateSuccessDesc: "تم تحديث ورشة العمل بنجاح",
        deleteSuccess: "تم حذف ورشة العمل",
        deleteSuccessDesc: "تم حذف ورشة العمل بنجاح",
        onlyForArtistsGalleries: "متاح فقط للفنانين والمعارض",
        categories: {
          painting: "الرسم",
          sculpture: "النحت",
...
i18n.use(initReactI18next).init({
  ...
  returnNull: false,
  returnObjects: false,
  initImmediate: false, // Prevent double initialization
});
