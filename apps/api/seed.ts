  ...
  artists: [
    {
      ...
      nameAr: 'منال الدويان',
      biography:
        'Manal AlDowayan is a pioneering Saudi artist known for her multimedia installations and video art that explore themes of identity, memory, and social transformation in contemporary Saudi Arabia.',
      biographyAr:
        'منال الدويان فنانة سعودية رائدة معروفة بأعمالها التركيبية متعددة الوسائط وفن الفيديو التي تستكشف موضوعات الهوية والذاكرة والتحول الاجتماعي في المملكة العربية السعودية المعاصرة.',
    ...
    },
    {
      ...
      nameAr: 'أحمد ماطر',
      biography:
        'Ahmed Mater is a Saudi artist and physician whose work examines the rapid transformation of Saudi society through photography, sculpture, and installation art.',
      biographyAr:
        'أحمد ماطر فنان وطبيب سعودي يدرس في أعماله التحول السريع للمجتمع السعودي من خلال التصوير الفوتوغرافي والنحت والفن التركيبي.',
      nationality: 'Saudi Arabia',
      birthYear: 1979,
      profileImage:
    ...
    },
    {
      ...
      nameAr: 'ريم آل فيصل',
      biography:
        'Princess Reem Al Faisal is a renowned Saudi artist and curator known for her abstract paintings and her role in promoting contemporary art in the Kingdom.',
      biographyAr:
        'الأميرة ريم آل فيصل فنانة ومنسقة معارض سعودية مشهورة بلوحاتها التجريدية ودورها في تعزيز الفن المعاصر في المملكة.',
      nationality: 'Saudi Arabia',
      birthYear: 1952,
      profileImage:
        'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face',
      coverImage:
        'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=1200&h=400&fit=crop',
      featured: true,
    ...
    },
    {
      ...
      biography:
        'An influential Iraqi artist who developed the One Dimension Group and significantly influenced modern Arab art with his theoretical writings and paintings.',
      biographyAr:
        'فنان عراقي مؤثر طور جماعة البعد الواحد وأثر بشكل كبير على الفن العربي الحديث من خلال كتاباته النظرية ولوحاته.',
      nationality: 'Iraq',
      birthYear: 1925,
      deathYear: 2004,
      profileImage:
    ...
    },
    {
      ...
      nameAr: 'فريد بلكاهية',
      biography:
        'Moroccan artist who pioneered the use of traditional materials like copper and leather in contemporary art, bridging traditional and modern aesthetics.',
      biographyAr:
        'فنان مغربي رائد في استخدام المواد التقليدية مثل النحاس والجلد في الفن المعاصر، واصل بين الجماليات التقليدية والحديثة.',
      nationality: 'Morocco',
      birthYear: 1934,
      deathYear: 2014,
      profileImage:
      ...
      coverImage:
        'https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?w=1200&h=400&fit=crop',
    ...
    },
    {
      ...
      nameAr: 'لالة الصايدي',
      biography:
        'Moroccan photographer and installation artist known for her staged photographs that explore the intersection of tradition and modernity in Arab culture.',
      biographyAr:
        'مصورة ومفنانة تركيبية مغربية معروفة بصورها المنسقة التي تستكشف تقاطع التقليد والحداثة في الثقافة العربية.',
      nationality: 'Morocco',
      birthYear: 1956,
      profileImage:
    ...
    },
    {
      ...
      nameAr: 'منى السعودي',
      biography:
        'Jordanian sculptor and painter known for her abstract sculptures and advocacy for Arab women artists, one of the most prominent female artists in the Arab world.',
      biographyAr:
        'نحاتة ورسامة أردنية معروفة بمنحوتاتها التجريدية ودفاعها عن الفنانات العربيات، من أبرز الفنانات في العالم العربي.',
      nationality: 'Jordan',
      birthYear: 1945,
      profileImage:
        'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=300&h=300&fit=crop&crop=face',
    ...
    },
    {
      ...
      nameAr: 'حسن حجاج',
      biography:
        "Moroccan-British artist known as the 'Andy Warhol of Marrakech' for his vibrant pop art photography and installation work.",
      biographyAr:
        "فنان مغربي-بريطاني معروف بـ'أندي وارهول مراكش' لأعماله الفوتوغرافية النابضة بالحياة والفن التركيبي.",
      nationality: 'Morocco',
      birthYear: 1961,
      profileImage:
  ...
  galleries: [
    {
      ...
      nameAr: 'أثر غاليري',
      description:
        'Athr Gallery is a contemporary art gallery in Jeddah, Saudi Arabia, dedicated to promoting contemporary art practice in the region.',
      descriptionAr:
        'أثر غاليري معرض فني معاصر في جدة، المملكة العربية السعودية، مخصص لتعزيز ممارسة الفن المعاصر في المنطقة.',
      location: 'Jeddah, Saudi Arabia',
      establishedYear: 2009,
      website: 'https://athrgallery.com',
      instagram: 'athrgallery',
      profileImage:
        'https://images.unsplash.com/photo-1554907984-15263bfd63bd?w=300&h=300&fit=crop',
      coverImage:
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&h=400&fit=crop',
      featured: true,
    ...
    },
    {
      ...
      description:
        'Leila Heller Gallery Dubai specializes in contemporary art from the Middle East, South Asia, and Africa.',
      descriptionAr:
        'معرض ليلى هيلر دبي متخصص في الفن المعاصر من الشرق الأوسط وجنوب آسيا وأفريقيا.',
      location: 'Dubai, UAE',
    ...
    },
    {
      ...
      nameAr: 'معرض حافظ',
      description:
        'Hafez Gallery is a contemporary art gallery in Jeddah showcasing both established and emerging artists from the region.',
    ...
    },
    {
      ...
      nameAr: 'مستودع 421',
      description:
        'Warehouse421 is a contemporary art space in Abu Dhabi that hosts exhibitions, workshops, and cultural events.',
      descriptionAr:
        'مستودع 421 مساحة فنية معاصرة في أبوظبي تستضيف معارض وورش عمل وفعاليات ثقافية.',
  ...
  artworks: [
    {
      ...
      description:
        "A powerful multimedia installation exploring themes of memory, identity, and the hypothetical nature of looking back on one's life choices.",
      descriptionAr:
        'تركيب متعدد الوسائط قوي يستكشف موضوعات الذاكرة والهوية والطبيعة الافتراضية للنظر إلى الوراء في خيارات الحياة.',
    ...
    },
    {
      ...
      titleAr: 'المغناطيسية',
      description:
        'A sculpture examining the magnetic pull of Mecca and its effect on global Muslim communities, created using metal filings and magnetic fields.',
      descriptionAr:
        'منحوتة تدرس الجذب المغناطيسي لمكة وتأثيره على المجتمعات المسلمة العالمية، مصنوعة باستخدام برادة المعادن والمجالات المغناطيسية.',
    ...
    },
    {
      ...
      description:
        'Abstract paintings inspired by the colors and forms of the Arabian desert, exploring the spiritual connection between landscape and identity.',
      descriptionAr:
        'لوحات تجريدية مستوحاة من ألوان وأشكال الصحراء العربية، تستكشف الروابط الروحية بين المناظر الطبيعية والهوية.',
    ...
    },
    {
      ...
      description:
        'A serene abstract painting that captures the meditative quality of Islamic art through geometric patterns and calligraphic elements.',
      descriptionAr:
        'لوحة تجريدية هادئة تلتقط الجودة التأملية للفن الإسلامي من خلال الأنماط الهندسية والعناصر الخطية.',
    ...
    },
    {
      ...
      description:
        'A mixed media artwork combining traditional leather craftsmanship with contemporary artistic expression, bridging past and present.',
      descriptionAr:
        'عمل فني مختلط يجمع بين الحرفية التقليدية للجلود والتعبير الفني المعاصر، يربط بين الماضي والحاضر.',
    ...
    },
    {
      ...
      description:
        'A photographic series that reclaims and recontextualizes the orientalist vision of Arab women, presenting them as empowered subjects rather than objects.',
      descriptionAr:
        'سلسلة فوتوغرافية تستعيد وتعيد تسياق الرؤية الاستشراقية للمرأة العربية، تقدمها كذوات مُمكنة بدلاً من أشياء.',
    ...
    },
    {
      ...
      description:
        'An abstract sculpture that explores the relationship between memory and materiality, carved from local stone with contemporary techniques.',
      descriptionAr:
        'منحوتة تجريدية تستكشف العلاقة بين الذاكرة والمادية، منحوتة من الحجر المحلي بتقنيات معاصرة.',
      ...
      currency: 'SAR',
      status: 'available',
      images: ['https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?w=800&h=600&fit=crop'],
    },
    {
      artistId: 8,
      galleryId: 4,
      ...
      titleAr: 'أحلام مراكش',
      description:
        'A vibrant pop art installation combining traditional Moroccan patterns with contemporary urban aesthetics, celebrating cultural fusion.',
      descriptionAr:
        'تركيب فني نابض بالحياة يجمع بين الأنماط المغربية التقليدية والجماليات الحضرية المعاصرة، احتفالاً بالاندماج الثقافي.',
  ...
  workshops: [
    {
      ...
      description:
        "Learn the fundamentals of Arabic calligraphy with master calligrapher. Explore traditional scripts including Naskh, Thuluth, and Ruq'ah.",
      descriptionAr:
        'تعلم أساسيات الخط العربي مع أستاذ الخط. استكشف الخطوط التقليدية بما في ذلك النسخ والثلث والرقعة.',
      instructorId: '89',
    ...
    },
    {
      ...
      description:
        'Explore modern painting techniques including abstract expressionism, color theory, and mixed media applications.',
      descriptionAr:
        'استكشف تقنيات الرسم الحديثة بما في ذلك التعبيرية التجريدية ونظرية الألوان وتطبيقات الوسائط المختلطة.',
      instructorId: '90',
      instructorType: 'artist',
      category: 'Painting',
      categoryAr: 'الرسم',
    ...
    },
    {
      ...
      description:
        'Master digital art creation techniques and understand the NFT marketplace. Learn industry-standard software and blockchain concepts.',
      descriptionAr:
        'أتقن تقنيات إنشاء الفن الرقمي وافهم سوق الرموز غير القابلة للاستبدال. تعلم البرامج المعيارية ومفاهيم البلوك تشين.',
      instructorId: '49',
    ...
    },
    {
      ...
      description:
        'Hands-on workshop exploring clay modeling, stone carving, and modern sculpture techniques with professional tools.',
      descriptionAr:
        'ورشة عملية لاستكشاف نمذجة الطين ونحت الحجر وتقنيات النحت الحديثة بالأدوات المهنية.',
      instructorId: '91',
      instructorType: 'artist',
      category: 'Sculpture',
      categoryAr: 'النحت',
    ...
    },
    {
      ...
      description:
        'Essential workshop for artists to learn about pricing, marketing, gallery representation, and building an art career.',
  ...
  events: [
    {
      ...
      description:
        "Join us for the grand opening of Saudi Art Week featuring contemporary exhibitions, live performances, artist talks, and networking opportunities with the region's leading art community.",
      descriptionAr:
        'انضم إلينا في الافتتاح الكبير لأسبوع الفن السعودي مع معارض معاصرة وعروض حية ومحاضرات فنانين وفرص التواصل مع مجتمع الفن الرائد في المنطقة.',
      organizerId: '49',
    ...
    },
    {
      ...
      description:
        'A comprehensive panel discussion with leading contemporary artists, curators, and critics exploring the future directions of Middle Eastern contemporary art.',
      descriptionAr:
        'نقاش شامل مع الفنانين المعاصرين والقيمين والنقاد الرائدين لاستكشاف الاتجاهات المستقبلية للفن المعاصر الشرق أوسطي.',
      organizerId: '50',
      organizerType: 'gallery',
      category: 'Talk',
      categoryAr: 'محاضرة',
    ...
    },
    {
      ...
      description:
        'An exclusive networking event for emerging art collectors to learn collection strategies, meet established collectors, and view rare private collections.',
      descriptionAr:
        'حدث تواصل حصري لجامعي الفن الناشئين لتعلم استراتيجيات الجمع ولقاء الجامعين الراسخين ومشاهدة المجموعات الخاصة النادرة.',
      organizerId: '51',
      organizerType: 'gallery',
      category: 'Networking',
      categoryAr: 'التواصل',
    ...
    },
    {
      ...
      description:
        'Explore the intersection of art and technology featuring VR installations, AI art, blockchain applications, and digital preservation methods.',
      descriptionAr:
        'استكشف تقاطع الفن والتكنولوجيا مع تركيبات الواقع الافتراضي وفن الذكاء الاصطناعي وتطبيقات البلوك تشين وطرق الحفظ الرقمي.',
      organizerId: '52',
    ...
    },
    {
      ...
      description:
        'Hands-on workshop dedicated to preserving and reviving traditional Saudi crafts including pottery, weaving, metalwork, and traditional jewelry making.',
      descriptionAr:
        'ورشة عملية مخصصة للحفاظ على الحرف التقليدية السعودية وإحيائها بما في ذلك الفخار والنسيج والأشغال المعدنية وصناعة المجوهرات التقليدية.',
      organizerId: '89',
  ...
  commissionRequests: [
    {
      ...
      description:
        'Looking for a custom Arabic calligraphy piece for my home office, incorporating verses from classical Arabic poetry.',
      descriptionAr:
        'أبحث عن قطعة خط عربي مخصصة لمكتبي المنزلي، تتضمن آيات من الشعر العربي الكلاسيكي.',
      budget: 15000,
      currency: 'SAR',
    ...
    },
    {
      ...
      description:
        'Seeking an artist to create a contemporary portrait of my family in a modern abstract style.',
    ...
    },
    {
      ...
      description:
        'Need a large-scale installation for our corporate headquarters lobby, should reflect Saudi heritage and modern business values.',
      descriptionAr:
        'نحتاج تركيباً فنياً كبير الحجم لردهة مقر شركتنا، يجب أن يعكس التراث السعودي وقيم الأعمال الحديثة.',
      budget: 150000,
      currency: 'SAR',
...
export async function seedDatabase() {
  ...
  try {
    ...
    const workshopData = mockData.workshops.map((workshop) => ({
      ...
      instructorId:
        workshop.instructorType === 'artist'
          ? insertedArtists
              .find((a) => a.id.toString() === workshop.instructorId)
              ?.id?.toString() || insertedArtists[0].id.toString()
          : insertedGalleries
              .find((g) => g.id.toString() === workshop.instructorId)
              ?.id?.toString() || insertedGalleries[0].id.toString(),
    }));
    ...
    const eventData = mockData.events.map((event) => ({
      ...
      organizerId:
        event.organizerType === 'gallery'
          ? insertedGalleries.find((g) => g.id.toString() === event.organizerId)?.id?.toString() ||
            insertedGalleries[0].id.toString()
          : insertedUsers[0].id,
    }));
    ...
    const insertedCommissions = await db
    ...
    const inquiriesData = [
      {
        ...
        message:
          "I'm interested in learning more about this artwork. Could you provide additional details about the materials used?",
        email: 'ahmed@example.com',
        phone: '+966501234567',
        status: 'pending',
      },
      {
        ...
        message:
          "Beautiful sculpture! I'd like to know more about the artist's inspiration and if there are similar works available.",
        email: 'fatima@example.com',
        status: 'responded',
      },
      {
